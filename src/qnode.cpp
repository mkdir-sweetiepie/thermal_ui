...
#include <sstream>
#include "../include/thermal_ui/qnode.hpp"
...
bool QNode::init()
{
  ros::init(init_argc, init_argv, "thermal_ui");
  if (!ros::master::check())
  {
    return false;
  }
  ...
  subImage = image.subscribe("/thermal_camera/image_colored", 1, &QNode::callbackImage, this);  // 서브스크라이버
